define(
    ['jquery', 'underscore', 'backbone', 'views/view', 'crel', 'reports/row', 'reports/column'],
    function ($, _, Backbone, View, crel, row, column) {
        'use strict';
        var defaultReport,
            deserialize,
            getModelFromObject,
        ...
        _.extend(exports.View.prototype, {
            ...
            layoutRow: function (cid) {
                return crel('div', {class: 'row', 'data-cid': cid}, 'Empty Row');
            },
