define(
    ['jquery', 'underscore', 'backbone', 'app', 'views/view', 'views/loading', 'crel', 'json!./modules/list.json', 'select2'],
    function ($, _, Backbone, app, View, Loading, crel, moduleList) {
        'use strict';
        var exports = {};
        ...
        _.extend(exports.View.prototype, {
            ...
            setSpan: function (span) {
                ...
                var $el = this.$el,
                    spanNum = /^col-lg-[1-9][0-2]{0,1} col-md-[1-9][0-2]{0,1} col-sm-[1-9][0-2]{0,1} col-xs-[1-9][0-2]{0,1}$/,
                    numeric = /^[1-9][0-2]{0,1}$/;
                if (spanNum.test(span)) {
                    ...
                    $el.removeClass(this.span)
                        .addClass(this.span = 'col-lg-' + span + ' col-md-' + span + ' col-sm-' + span + ' col-xs-' + span);
                } else {
                    $el.removeClass(this.span);
                    this.span = '';
                }
            ...
            showLoading: function () {
                this._loading = this._loading || new Loading();
                this.closeCurrent();
                this.$('.module').html(
                    this._loading.render().$el
                );
                return this;
            },
