define(
    ['jquery', 'underscore', 'backbone', 'crel', 'app', 'moment', 'views/view', 'lists/pager', 'core/js/API/violations'],
    function ($, _, Backbone, crel, app, moment, View, Pager, violations) {
        'use strict';
        var exports = {};
        exports.name = 'list';
        exports.models = {
        ...
        exports.views = {
            Main: View.extend({
                ...
                initialize: function () {
                    ...
                    var violationCollection = Pager.Collection.extend({

                    });
                    this.collection = new violationCollection();
                    this.collection.baseUrl = url;
