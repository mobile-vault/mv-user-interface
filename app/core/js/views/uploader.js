define(
    ['jquery', 'underscore', 'backbone', 'crel', 'modals/baseModal', 'text!template/modals/uploadModal.html'],
    function ($, _, Backbone, crel, BaseModal, myTemplate) {
        'use strict';
        var exports = {
            ...
            View: BaseModal.View.extend({
                ...
                init: function () {
                    ...
                    this.listenTo(this.userCollection, 'sync', this.renderContent);
                ...
                renderContent: function () {
                    var template = _.template(this.template),
                        operatingSystems = this.userCollection.toJSON()[0],
                        data = {
